...
const Quiz = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const response = await axios.get(`https://mcq-battlequest-1.onrender.com/game/${_id}`);
  ...
  const updateDashboard = async () => {
    ...
    try {
      await axios.post('https://mcq-battlequest-1.onrender.com/dashboard', data);
  ...
  const updateDashboardAndAccuracy = async () => {
    ...
    try {
      await axios.post('https://mcq-battlequest-1.onrender.com/accuracy', AccuracySubject);
      console.log("Subject Accuracy updated successfully");
  
      await axios.post('https://mcq-battlequest-1.onrender.com/accuracy', AccuracyDifficulty);
